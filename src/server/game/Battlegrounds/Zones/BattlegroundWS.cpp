...
void BattlegroundWS::PostUpdateImpl(uint32 diff)
{
    ...
    {
        if (GetStartTime() >= 127*MINUTE*IN_MILLISECONDS)
        {
        ...
        {
            ++_minutesElapsed;
            UpdateWorldState(BG_WS_STATE_TIMER, 125 - _minutesElapsed);
        }
...
void BattlegroundWS::StartingEventCloseDoors()
{
    ...
    UpdateWorldState(BG_WS_STATE_TIMER, 125);
}
...
bool BattlegroundWS::SetupBattleground()
{
    ...
    if (!AddObject(BG_WS_OBJECT_A_FLAG, BG_OBJECT_A_FLAG_WS_ENTRY, 1540.423f, 1481.325f, 351.8284f, 3.089233f, 0, 0, 0.9996573f, 0.02617699f, BG_WS_FLAG_RESPAWN_TIME/1000)
        ...
        || !AddObject(BG_WS_OBJECT_REGENBUFF_1, BG_OBJECTID_REGENBUFF_ENTRY, 1317.506f, 1550.851f, 313.2344f, -0.2617996f, 0, 0, 0.1305263f, -0.9914448f, REGENBUFF_RESPAWN_TIME)
        || !AddObject(BG_WS_OBJECT_REGENBUFF_2, BG_OBJECTID_REGENBUFF_ENTRY, 1110.451f, 1353.656f, 316.5181f, -0.6806787f, 0, 0, 0.333807f, -0.9426414f, REGENBUFF_RESPAWN_TIME)
        || !AddObject(BG_WS_OBJECT_BERSERKBUFF_1, BG_OBJECTID_BERSERKERBUFF_ENTRY, 1320.09f, 1378.79f, 314.7532f, 1.186824f, 0, 0, 0.5591929f, 0.8290376f, BERSERKBUFF_RESPAWN_TIME)
        || !AddObject(BG_WS_OBJECT_BERSERKBUFF_2, BG_OBJECTID_BERSERKERBUFF_ENTRY, 1139.688f, 1560.288f, 306.8432f, -2.443461f, 0, 0, 0.9396926f, -0.3420201f, BERSERKBUFF_RESPAWN_TIME)
        // alliance gates
...
void BattlegroundWS::FillInitialWorldStates(WorldPacket& data)
{
    ...
    if (GetStatus() == STATUS_IN_PROGRESS)
    {
        ...
        data << uint32(BG_WS_STATE_TIMER) << uint32(125-_minutesElapsed);
    }
    else
